...
//Выбирает все простые числа до заданного (случайно сгенерированного).
int sundaram(int n)
{
...
//Алгоритм для нахождения наибольшего общего делителя двух целых чисел. Используется для проверки чисел на взаимопростоту.
int gcd(int a, int b)
{
	int c;
	while (b)
